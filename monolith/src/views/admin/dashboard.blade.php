...
<div class="grid grid-cols-1 md:grids-cols-2">
    ...
    <div
        ...
        <form method="POST" action="{{url('/admin/dashboard')}}" enctype="multipart/form-data" class="space-y-6" action="#">
            ...
            <div>
                ...
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">About Summary</label>
