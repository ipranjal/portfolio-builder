...
@section('main')
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400 mb-6">Welcome back to your portfolio admin!</p>
        @include('component.alert')

            <form action={{url('/admin')}} method="POST" class="max-w-sm mx-auto">
                <div class="mb-5">
