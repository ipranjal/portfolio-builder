...
@section('content')
    ...
    <form action="{{url('/projects')}}" method="POST" enctype="multipart/form-data" class="space-y-6" action="#">
        <h5 class="text-xl font-medium text-gray-900 ">Details of Project</h5>
        <img class="w-40 h-40 mt-2" src="{{$project->img}}" alt="Extra large avatar">
        ...
        <div>
            ...
            <input type="name" name="title" id="email" value="{{$project->title}}"
        ...
        <div>
            ...
            <textarea id="message" rows="4"
                ...
                placeholder="Short summary of project..." name="summary" required>{{$project->summary}}</textarea>
        ...
        <div class="w-full bg-white border border-gray-200 rounded-lg shadow ">
            ...
            <input type="name" name="link" id="email" value="{{$project->link}}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
